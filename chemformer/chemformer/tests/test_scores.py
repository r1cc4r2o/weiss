...
def test_default_inference_scoring():
    ...
    assert metrics_scores["fraction_invalid"] == 0.5
    assert round(metrics_scores["fraction_unique"], 4) == 0.6667
...
@pytest.mark.parametrize(
    ...
    [
        ([["CCO", "CCO", "CCO"], ["c1cc!ccc1", "c1cccc1", "c1ccccc1"]], ["CCO", "c1ccccc1"], 0.5),
        ([["CCO", "CCO", "CCO"], ["c1ccccc1", "c1cccc1", "c1ccccc1"]], ["CCO", "c1ccccc1"], 0.0),
        ([["CCO", "C!O", "CCO"], ["c1ccccc1", "c1cccc1", "c1ccccc1"]], ["CCO", "c1ccccc1"], 0.0),
    ],
)
...
@pytest.mark.parametrize(
    ("sampled_smiles", "target_smiles", "expected_score"),
    [
        ([["CCO", "CCO", "CCO"], ["c1cc!ccc1", "c1cccc1", "c1ccccc1"]], ["CCO", "c1ccccc1"], 0.6667),
        ([["CCO", "CCO", "CCO"], ["c1ccccc1", "c1cccc1", "c1ccccc1"]], ["CCO", "c1ccccc1"], 0.5),
        ([["CCO", "C!O", "COO"], ["c1ccccc1", "c1cccc1", "c1cc(Br)ccc1"]], ["CCO", "c1ccccc1"], 1.0),
    ],
)
