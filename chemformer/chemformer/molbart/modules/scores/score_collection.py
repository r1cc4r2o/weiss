...
from molbart.modules.base_collection import BaseCollection
from molbart.modules.scores import BaseScore
from molbart.modules.scores.scores import __name__ as score_module
...
class ScoreCollection(BaseCollection):
    ...
    def load_from_config(self, scores_config: DictConfig) -> None:
        """
        Load one or several scores from a configuration dictionary

        The keys are the name of score class. If a score is not
        defined in the ``molbart.modules.scores.scores`` module, the module
