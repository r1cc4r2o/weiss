...
def create_round_trip_dataset(args: Namespace) -> Tuple[Namespace, Dict[str, Any]]:
    ...
    if not working_directory.endswith("/"):
        working_directory += "/"
    round_trip_input_data = working_directory + "tmp_round_trip_input.csv"
...
def main(args) -> None:
    ...
    sampled_smiles, target_smiles = rt_utils.convert_to_input_format(sampled_smiles, target_smiles, sampled_data_params)
