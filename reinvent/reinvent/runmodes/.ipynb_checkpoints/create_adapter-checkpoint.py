...
def create_adapter(dict_filename: str, mode: str, device: torch.device) -> tuple:
    ...
    if "model_type" in save_dict:
        ...
        if model_type == "Linkinvent" and save_dict.get("version", -1) == 2:
            model_type += "Transformer"
        elif model_type == "One2Many" and save_dict.get("version", -1) == 2:
            model_type += "Transformer"
        elif model_type == "One2One" and save_dict.get("version", -1) == 2:
            model_type += "Transformer"
    else:
