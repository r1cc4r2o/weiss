...
class Learning(ABC):
    ...
    def _update_common_transformer_one2many(self, results: ScoreResults):
        """Common update for Transformer-based models, Mol2Mol, LibInvent and LinkInvent
        ...
        prior_nlls, z = self.prior.likelihood(
    ...
    def _setup_reporters(self, tb_logdir):
        ...
        for kls, args in (
            ...
            if args[0]:  # FIXME: remote reporter will be a class in any case
