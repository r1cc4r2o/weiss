"""The One2Many sampling module"""

__all__ = ["One2ManyTransformerSampler"]
...
from reinvent.models.model_factory.sample_batch import SampleBatch, SampleBatchZ
...
class One2ManyTransformerSampler(Sampler):
    """Carry out sampling with Mol2Mol"""

    def sample(self, smilies: List[str]) -> SampleBatchZ:
        ...
        sampled = SampleBatchZ.from_list(sequences)
