# This file contains the NoamOptimizer class which is a wrapper around the Adam optimizer   
# with a learning rate schedule described in the paper "Attention is All You Need".
